...
class Files extends handlerbase_1.HandlerBase {
                    ...
                    return (() => {
                        return new Promise((_res, _rej) => __awaiter(this, void 0, void 0, function* () {
                            if (wp.Contents.FileSrc) {
                                const fileSrc = util_1.replaceUrlTokens(util_1.replaceContextTokens(wp.Contents.FileSrc, this.context));
    ...
    getFileBlob(file) {
        return __awaiter(this, void 0, void 0, function* () {
            const fileSrcWithoutTokens = util_1.replaceUrlTokens(util_1.replaceContextTokens(file.Src, this.context));
        ...
        return new Promise((resolve, reject) => __awaiter(this, void 0, void 0, function* () {
            ...
            if (file.WebParts && file.WebParts.length > 0) {
                ...
                file.WebParts.forEach(wp => {
                    const webPartXml = util_1.replaceContextTokens(this.replaceWebPartXmlTokens(wp.Contents.Xml, clientContext), this.context);
